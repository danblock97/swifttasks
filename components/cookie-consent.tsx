...
export function CookieConsentBanner() {
    ...
    return (
        <div className="fixed bottom-0 inset-x-0 z-50 p-4 md:p-6 flex justify-center backdrop-blur-sm">
            <div className="bg-background border rounded-lg shadow-lg p-4 max-w-3xl flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        You can read more in our <a href="/privacy" className="underline font-medium">Privacy Policy</a>.
                    </p>
                </div>
