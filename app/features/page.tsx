...
export default function FeaturesPage() {
    return (
        <main className="flex-1">
            ...
            <section className="py-16 md:py-24 bg-white">
                <div className="container px-4 sm:px-6 max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Todo Lists Feature */}
                        <Card className="flex flex-col h-full bg-white border-2 border-indigo-100 hover:border-indigo-200 hover:shadow-md transition-all">
                            <CardHeader>
                        ...
                        <Card className="flex flex-col h-full bg-white border-2 border-blue-100 hover:border-blue-200 hover:shadow-md transition-all">
                            <CardHeader>
                                <div className="flex justify-center mb-4">
                        ...
                        <Card className="flex flex-col h-full bg-white border-2 border-teal-100 hover:border-teal-200 hover:shadow-md transition-all">
                            <CardHeader>
                                <div className="flex justify-center mb-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-2">
                                    <div className="h-6 w-6 bg-blue-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                        <Users className="h-3.5 w-3.5 text-blue-700" />
                                    </div>
                                    <div>
                                        <span className="font-medium block mb-1">Team Workspaces</span>
                                        <span className="text-slate-600 text-sm">Create dedicated spaces for your team to collaborate on projects</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-2">
                                    <div className="h-6 w-6 bg-blue-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-slate-600 text-sm">Assign tasks to team members and track ownership</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-2">
                                    <div className="h-6 w-6 bg-blue-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-slate-600 text-sm">Create and share knowledge bases with your entire team</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div className="bg-white rounded-lg shadow-xl p-8 border border-blue-100">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div className="text-sm">
                                        ...
                                        <p className="text-slate-500 text-xs">3 team members</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-sm text-slate-500">8/12 completed</span>
                                    </div>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-md">
                                        <Checkbox className="h-5 w-5 rounded-sm bg-white" checked={true} />
                                        <div className="flex-1">
                                            <p className="font-medium text-sm line-through text-slate-500">Create content calendar</p>
                                            <div className="flex items-center mt-1 gap-2">
                                                <span className="text-xs text-slate-500">Completed by JD</span>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-white border rounded-md">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center mt-1 gap-2">
                                                <span className="text-xs text-slate-500">Assigned to AR</span>
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-white border rounded-md">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="flex items-center mt-1 gap-2">
                                                ...
                                                <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">To Do</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="container px-4 sm:px-6 max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="relative order-2 md:order-1">
                            <div className="bg-white rounded-lg shadow-xl p-8 border border-indigo-100">
                                <div className="mb-6">
                                    <h4 className="font-medium mb-1">My Dashboard</h4>
                                    <p className="text-sm text-slate-500">Wednesday, March 20, 2025</p>
                                </div>

                                <div className="grid grid-cols-2 gap-4 mb-6">
                                    <div className="bg-indigo-50 rounded-lg p-4">
                                        <h5 className="text-xs text-indigo-600 font-medium mb-2">Tasks</h5>
                                        <p className="text-2xl font-bold">7</p>
                                        <p className="text-xs text-slate-500 mt-1">3 due today</p>
                                    </div>
                                    <div className="bg-teal-50 rounded-lg p-4">
                                        <h5 className="text-xs text-teal-600 font-medium mb-2">Projects</h5>
                                        <p className="text-2xl font-bold">2</p>
                                        <p className="text-xs text-slate-500 mt-1">1 updated</p>
                                    </div>
                                </div>
                        ...
                        <span className="text-xs text-slate-500 flex items-center gap-1">
                          ...
                          Due today
                                                ...
                                                <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">Low</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Decorative elements */}
                            <div className="absolute -right-6 -bottom-6 w-32 h-32 bg-gradient-to-br from-indigo-100/50 to-purple-100/50 rounded-full -z-10"></div>
                            <div className="absolute -left-6 -top-6 w-24 h-24 bg-gradient-to-tr from-teal-100/50 to-indigo-100/50 rounded-full -z-10"></div>
                        </div>
                        ...
                        <div className="order-1 md:order-2">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start gap-2">
                                    <div className="h-6 w-6 bg-indigo-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                        <CheckCircle2 className="h-3.5 w-3.5 text-indigo-700" />
                                    </div>
                                    <div>
                                        <span className="font-medium block mb-1">Personal Dashboard</span>
                                        <span className="text-slate-600 text-sm">Get a quick overview of your tasks and priorities</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-2">
                                    <div className="h-6 w-6 bg-indigo-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-slate-600 text-sm">Never miss a deadline with task prioritization</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-2">
                                    <div className="h-6 w-6 bg-indigo-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                                        <Kanban className="h-3.5 w-3.5 text-indigo-700" />
                                    </div>
                                    <div>
                                        <span className="font-medium block mb-1">Visual Organization</span>
                                        <span className="text-slate-600 text-sm">Organize your work visually with personal kanban boards</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            {/* CTA Section */}
            <section className="py-20 md:py-28 bg-gradient-to-r from-blue-50 via-white to-teal-50">
...
const Checkbox = ({ className, checked = false }: CheckboxProps) => {
    return (
        <div className={`border ${checked ? 'bg-blue-600 border-blue-600' : 'bg-white border-slate-300'} rounded flex items-center justify-center ${className}`}>
            {checked && (
